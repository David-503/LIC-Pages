...
function init() {
    ...
    contenido += "\t<li>\n";
    contenido +=
        '\t\t<a href="javascript:void(0)"><span>Multiplicar</span></a>\n';
    contenido += "</li>\n";
    contenido += "\t<li>\n";
        ...
        switch (i) {
            ...
            case 3:
                opciones[i].onclick = function () {
                    if (op2 == 0) {
                        resultado.innerHTML =
                            '<p class="letterpress">No se puede dividir entre cero</p>';
                    } else {
                        resultado.innerHTML =
                            '<p class="letterpress">' +
                            op1 +
            ...
            case 4:
                opciones[i].onclick = function () {
                    if (op2 == 0) {
                        resultado.innerHTML =
                            '<p class="letterpress">No se ha podido obtener el residuo, por división entre cero.</p>\n';
                    } else {
                        resultado.innerHTML =
                            '<p class="letterpress">' +
                            op1 +
